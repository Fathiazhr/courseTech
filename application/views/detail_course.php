...
<section class="page-banner" style="background-image: url(assets/images/banner5.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="banner-title">Detail Kursus</h2>
                <div class="bread-crumbs">
                    <a href="<?= base_url() ?>">Home</a> <span></span> <a href="<?= base_url() ?>course">courses</a> <span></span> Detail Kursus
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="single-course-area">
                    ...
                    <div class="sc-thumb">
                        <img src="<?= base_url(); ?>assets/images/single-course/1.jpg" alt="">
                    </div>
                            ...
                            <div class="tab-pane fade in show active" id="instructors" role="tabpanel">
                                <div class="teacher-item-3">
                                    <div class="teacher-thumb">
                                        <img src="<?= base_url(); ?>assets/images/single-course/i1.jpg" alt="">
                                    </div>
                                        ...
                                        <ol>
                                            <li>
                                                <div class="single-comment">
                                                    <img src="<?= base_url(); ?>assets/images/single-course/r1.png" alt="">
                                                    <h5><a href="#">Dianne Ameter</a></h5>
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <img src="<?= base_url(); ?>assets/images/single-course/r2.png" alt="">
                                                    <h5><a href="#">Hugh Saturation</a></h5>
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <img src="<?= base_url(); ?>assets/images/single-course/r3.png" alt="">
                                                    <h5><a href="#">Jim Séchen</a></h5>
